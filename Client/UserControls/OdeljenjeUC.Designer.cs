namespace Client.UserControls
{
    partial class OdeljenjeUC
    {
        ...
        private void InitializeComponent()
        {
            ...
            ((System.ComponentModel.ISupportInitialize)dgvOdeljenja).BeginInit();
            ...
            lblPageTitle.Size = new Size(130, 41);
            lblPageTitle.TabIndex = 0;
            lblPageTitle.Text = "Odeljenja";
            //
            // lblPageSubtitle
            //
            ...
            lblPageSubtitle.Size = new Size(180, 15);
            lblPageSubtitle.TabIndex = 1;
            lblPageSubtitle.Text = "Upravljanje odeljenjima";
            //
            // pnlCardOuter
            //
            ...
            pnlCard.Controls.Add(dgvOdeljenja);
            ...
            // dgvOdeljenja
            //
            dgvOdeljenja.AllowUserToAddRows = false;
            dgvOdeljenja.AllowUserToDeleteRows = false;
            dgvOdeljenja.BackgroundColor = Color.White;
            dgvOdeljenja.BorderStyle = BorderStyle.None;
            dgvOdeljenja.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            dgvOdeljenja.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            dgvOdeljenja.ColumnHeadersHeight = 34;
            dgvOdeljenja.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
            dgvOdeljenja.Dock = DockStyle.Fill;
            dgvOdeljenja.EnableHeadersVisualStyles = false;
            dgvOdeljenja.GridColor = Color.FromArgb(238, 238, 238);
            dgvOdeljenja.Location = new Point(0, 55);
            dgvOdeljenja.MultiSelect = false;
            dgvOdeljenja.Name = "dgvOdeljenja";
            dgvOdeljenja.ReadOnly = true;
            dgvOdeljenja.RowHeadersVisible = false;
            dgvOdeljenja.RowTemplate.Height = 42;
            dgvOdeljenja.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgvOdeljenja.Size = new Size(712, 386);
            dgvOdeljenja.TabIndex = 0;
            dgvOdeljenja.CellFormatting += dgvOdeljenja_CellFormatting;
            dgvOdeljenja.SelectionChanged += dgvOdeljenja_SelectionChanged;
            //
            // pnlCardFooterDiv
            //
            ...
            lblStatus.Size = new Size(130, 15);
            ...
            lblCardTitle.Text = "Sva odeljenja";
            ...
            btnUbaci.Size = new Size(150, 34);
            btnUbaci.TabIndex = 0;
            btnUbaci.Text = "Novo odeljenje";
            ...
            btnPromeni.Location = new Point(182, 14);
            ...
            btnObrisi.Location = new Point(310, 14);
            ...
            ((System.ComponentModel.ISupportInitialize)dgvOdeljenja).EndInit();
        ...
        public DataGridView dgvOdeljenja;
